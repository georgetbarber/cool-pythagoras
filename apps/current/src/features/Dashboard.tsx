...
import { dueSkills, recommendedLesson, skillAccuracy, skillLabel, weakestSkills } from "../learning/engine";
import { displayRelationshipLabel } from "../core/music/theory";
    ...
    <div className="workspace-stack">
      ...
      <div className="dashboard-summary">
        ...
        <section className="panel summary-card">
          ...
          <span>{state.learning.totalPracticeMinutes} practice minutes · {due.length} reviews due</span>
          <p>{weak.length ? `Review: ${weak.map((skill) => skillLabel(skill.skill)).join(", ")}` : "Complete practice prompts to build a mastery picture."}</p>
        </section>
      </div>
        ...
        <div className="scale-ribbon">
          {model.scale.map((tone) => (
            <button
              ...
              key={tone.degree}
            >
              <small>Scale degree {displayRelationshipLabel(tone.degreeLabel)}</small>
