...
V8 implements the Musical Freedom Learning System. Further work should now be
driven by learner observation and musical review, not by adding dashboard breadth.

## Validation Priorities

1. Observe one learner completing the diagnostic and first two units without coaching.
2. Conduct manual guitar-playability and theory review across all 48 unit outlines.
...
- Author richer variations for each unit after the schemas remain stable in use.
...
A change proceeds only when it identifies the relationship being learned, the
observable musical action, the domain that owns the rule, the evidence it records,
and the complexity hidden until it becomes useful.
