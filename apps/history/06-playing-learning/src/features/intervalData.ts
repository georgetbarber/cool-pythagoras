export const INTERVALS = [
  ...
  { label: "4", short: "perfect 4th", description: "A stable distance that often suspends against a major third." },
  { label: "b5", short: "tritone", description: "Maximum instability, often resolving by semitone." },
