    ...
    <section className="panel shape-explorer">
      <div className="panel-heading">
        <div>
          ...
          <p>
            {shape
              ? `Bass C${shape.bassIntervalLabel} · pattern ${shape.fretPattern} · span ${shape.span} frets`
      ...
      <div className="shape-choices">
        {shapes.map((candidate, index) => (
          ...
          >
            ...
            <small>
              C{candidate.bassIntervalLabel} bass · {candidate.openStrings ? `${candidate.openStrings} open` : `position ${candidate.minFret}`}
            </small>
          </button>
        ))}
      </div>
