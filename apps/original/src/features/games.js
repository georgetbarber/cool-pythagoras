...
import { getChordNotes, getNoteName, CHROMATIC_SCALE_SIZE } from '../core/engine.js';
import { updateFretboard } from '../ui/fretboard.js';
...
export class PracticeController {
    ...
    initDOM() {
        ...
        import('../ui/fretboard.js').then(module => {
